...
/**
 * The class used for all forms of communication with the Zang REST API. It can be used to create
 * connectors based on a default configuration provided to this factory, or to create connectors
...
public class ZangConnectorFactory {
     ...
     *             created. All connectors created by this factory will use this configuration.
    ...
    /**
     * Creates a new ZangConnectorFactory based on the provided configuration with an
     * explicit http executor defined.
     * @param conf The configuration based on which the ZangConnectorFactory will be
     *             created. All connectors created by this factory will use this configuration.
    ...
    /**
     * Creates a connector for communicating with the Accounts endpoint
     * @param conf Explicit configuration to use with this connector
     * @return AccountsConnector
     */
     ...
     * Creates a connector for communicating with the Accounts endpoint
     * @param conf Explicit configuration to use with this connector
     * @param executor Explicit http executor to use with this connector
     * @return AccountsConnector
     */
    ...
    /**
     * Creates a connector for communicating with the Sip IP Access Control Lists endpoint
    ...
    /**
     * Creates a connector for communicating with the Incoming Phone Numbers endpoint
    ...
    /**
     * Creates a connector for communicating with the Available Phone Numbers endpoint
