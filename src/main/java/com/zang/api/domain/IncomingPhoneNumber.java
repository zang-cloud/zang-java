...
/**
 * Zang phone numbers associated with an account are represented with the IncomingPhoneNumber resource.
 */
public class IncomingPhoneNumber extends BaseZangObjectWithMethods{
	...
	/**
	 * @return Domestic format version of the Zang phone number. (e.g. 1234567890 to (123)-456-7890)
	 */
	...
	/**
	 * @return The type of Zang number. (local, international, etc.)
	 */
