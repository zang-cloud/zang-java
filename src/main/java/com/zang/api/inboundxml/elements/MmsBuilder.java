...
public class MmsBuilder {
	 ...
	 * the Avaya CPaaS number’s SMS request URL.
	 * 
	 * @param to
	 * @return
	 */
	 ...
	 * of your Avaya CPaaS numbers. If this parameter is not specified, the default from
	 * number is the Avaya CPaaS number hosting the SMS request URL.
	 * 
	 * @param from
	 * @return
	 */
	...
	/**
	 * URL to direct Avaya CPaaS to once the <Sms> element is executed. Parameters specific
