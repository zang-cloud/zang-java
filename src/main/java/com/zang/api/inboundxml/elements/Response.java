...
public class Response {
    ...
    static {
        ...
        try {
            ...
            schema = schemaFactory.newSchema(new File(Response.class.getResource("/inboundxml.xsd").getFile()));
    ...
    public Response(List<ResponseElement> content, String statusCallback, HttpMethod statusMethod, String heartbeatCallback, HttpMethod heartbeatMethod) {
