package com.zang.api.inboundxml.parameters;
...
public class DialParameters {
	...
	/**
	 * 
	 * @param digitsMatch Specifies digits that Zang should listen for and send to the callbackUrl if a caller inputs them. Separate additional digits or digit patterns with a comma. Allowed values are digits, # and *.
	 */
	...
	/**
	 * 
	 * @param heartbeatUrl A URL Zang can request every 60 seconds during the call to notify of elapsed time and pass other general information.
	 */
